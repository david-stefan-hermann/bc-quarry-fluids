...
/** Sent to the client when the quarry menu opens: where the quarry is and how the server configured it. */
public record QuarryMenuData(BlockPos pos, int rows, int fluidSlots, int capacityMb) {
    public static final StreamCodec<RegistryFriendlyByteBuf, QuarryMenuData> STREAM_CODEC = StreamCodec.composite(
        ...
        ByteBufCodecs.VAR_INT, QuarryMenuData::rows,
